<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchoolYearDets.aspx.cs" Inherits="OnlineExamSys.Web_Frms.SchoolYearDets" %>
    ...
    <div>
        ...
        <div style="margin-left: 120px;">
            ...
            <asp:HyperLink style="text-decoration: none;" ID="lCreate" runat="server"  
                NavigateUrl="~/Web Frms/SchoolYearFrm.aspx">Create New</asp:HyperLink>
        </div>
        
        <div style="margin-left: 120px; margin-top:20px;">
                <asp:GridView ID="GridView1" CellPadding="5" AutoGenerateColumns="False" runat="server" Width="800px" DataKeyNames="SchoolYearID" GridLines="None">
                    <Columns>

                        <asp:BoundField DataField="SchoolYearID" HeaderText="SchoolYear ID" 
                            SortExpression="SchoolYearID" >
                        ...
                        <asp:HyperLinkField ControlStyle-CssClass="Decor" Text="Edit" DataNavigateUrlFields="SchoolYearID,SchoolYear"         
                            DataNavigateUrlFormatString="UpdateSchoolYear.aspx?SchoolYearID={0}&SchoolYear={1}" >
                        <HeaderStyle HorizontalAlign="Right" Width="30px" />
                        </asp:HyperLinkField>

                        <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton style="text-decoration: none;" ID="lDelete" runat="server" CommandArgument='<%# Eval("SchoolYearID") %>' OnClick="lDelete_OnClick">Delete</asp:LinkButton>
                        </ItemTemplate>
                        </asp:TemplateField>
