<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateGradeFrm.aspx.cs" Inherits="OnlineExamSys.Web_Frms.UpdateGradeFrm" %>
...
<body>
    ...
    <div>
        ...
        <div style="margin-left: 120px; margin-top: 30px;">
            <asp:HyperLink style="text-decoration: none;" ID="lBack" runat="server" NavigateUrl="~/Web Frms/GradeDetsFrm.aspx">Back</asp:HyperLink>
        </div>
    </form>
        <div>
