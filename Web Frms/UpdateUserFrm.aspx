<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateUserFrm.aspx.cs" Inherits="OnlineExamSys.Web_Frms.UpdateUserFrm" %>
            ...
            <legend>Update Users</legend>
                <div style="margin-left: 60px; margin-top:30px;">
                    <label class="label"><span style="display:inline-block; padding-bottom: 0.5em; text-align:right; width:100px;">User ID:</span> 
                        <asp:TextBox ID="tID" Enabled="false" runat="server" Width="170px"></asp:TextBox>                    
                    </label>
                    <br />
                    ...
                    <br />
                    <label class="label"><span style="display:inline-block; padding-bottom: 0.5em; text-align:right; width:100px;">New Pass:</span> 
