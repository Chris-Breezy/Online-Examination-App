<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuestionaireFrm.aspx.cs" Inherits="OnlineExamSys.Web_Frms.QuestionaireFrm" %>
...
<body>
        ...
        <table>
            <tr>
                ...
                <fieldset style="width:350px; height:35px;">
                    ...
                    <asp:RadioButton ID="rd1" Text="Quarter 1" Enabled="true" GroupName="RadioButts" runat="server" />
                    <asp:RadioButton ID="rd2" Text="Quarter 2" Enabled="true" GroupName="RadioButts" runat="server" />
                    <asp:RadioButton ID="rd3" Text="Quarter 3" Enabled="true" GroupName="RadioButts" runat="server" />
                    <asp:RadioButton ID="rd4" Text="Quarter 4" Enabled="true" GroupName="RadioButts" runat="server" />
                </fieldset>
                </td>
            </tr>
        </table>
    ...
    <fieldset style="margin-top:20px; margin-left: 120px; width:600px; height:320px;">
        <legend><b>Questionaire Details</b></legend>
        ...
        <asp:TextBox ID="tID" Enabled="false" runat="server"></asp:TextBox>
        </label>
        ...
        <asp:TextBox ID="tQuestion" runat="server" Enabled="false" Height="54px" TextMode="MultiLine" 
        ...
        <asp:TextBox ID="tOp1" Enabled="false" runat="server"></asp:TextBox>
        </label>
        ...
        <asp:TextBox ID="tOp2" Enabled="false" runat="server"></asp:TextBox>
        </label>
        ...
        <asp:TextBox ID="tOp3" Enabled="false" runat="server"></asp:TextBox>
        </label>
        ...
        <asp:TextBox ID="tOp4" Enabled="false" runat="server"></asp:TextBox>
        </label>
        ...
        <asp:TextBox ID="tCorrect" Enabled="false" runat="server"></asp:TextBox>
        </label>
            <asp:Label ID="lCorrect" ForeColor="Red" runat="server" Text=""></asp:Label>
        <br />
            <span style="display:inline-block;">
                <asp:Button CssClass="Butones" ID="bSave" runat="server" Text="New" 
                Width="87px" BackColor="Gray" ForeColor="White" Height="30px" 
                onclick="bSave_Click" />    
            </span>
            
            <span style="display:inline-block;">
                <asp:Button ID="bCancel" Visible="false" runat="server" Text="Cancel"
                Width="87px" BackColor="Gray" ForeColor="White" Height="30px" 
