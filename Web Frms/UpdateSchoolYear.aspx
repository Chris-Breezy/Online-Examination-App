<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateSchoolYear.aspx.cs" Inherits="OnlineExamSys.Web_Frms.UpdateSchoolYear" %>
            ...
            <legend>Create School Year</legend>
                <div style="margin-left: 60px; margin-top:30px;">
                    <label>
                        ...
                        <asp:TextBox ID="tID" Enabled="false" runat="server" style=" text-align:center;"></asp:TextBox>
                    </label> 
                    <br />
